...
def main(args):
    ...
    for epoch in range(start, args.epochs):
        ...
        criterion = losses.create(args.loss, margin=args.margin, epoch_num = epoch, alpha=args.alpha, base=args.loss_base).cuda()

        train(epoch=epoch, model=model, criterion=criterion,
              optimizer=optimizer, train_loader=train_loader, args=args, margin = args.margin)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', '-b', default=125, type=int, metavar='N',
                        help='mini-batch size (1 = pure stochastic) Default: 256')
    parser.add_argument('--num_instances', default=5, type=int, metavar='n',
    ...
    parser.add_argument('--data', default='shop', required=True,
